...
//   constructor(productChoiceTitle, Choice, choiceList, setStateWattsHandler) {
//     this._productChoiceTitle = productChoiceTitle;
//     this._Choice = Choice;
//     this._choiceList = choiceList;
//     this._setStateWattsHandler = setStateWattsHandler;
//     this._init();
//   }
...
//   _setStateActiveHandler(id, text) {
//     this._resetStateActive();
//     this._setStateActive(id, text);
//     this._setStateWattsHandler(text);
//     this._render();
//   }
...
//   _generateChoice() {
//     return this._choiceList.map(({ id, text, unit }) => {
//       return new this._Choice(id, text, unit, this._setStateActiveHandler.bind(this), {
