...
export class ProductList {
  ...
  constructor(Product, IconMore, IconFavorite, ProductImg, ProductChoice, Choice, ProductButton, products) {
  ...
  _generateProduct(filteredProducts = this._products, searchWord = "") {
  ...
  _searchProducts() {
    ...
    return this._products.filter((product) => product.title.toLowerCase().includes(searchItem));
  }
